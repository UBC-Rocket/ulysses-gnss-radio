...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOB, FC_INT_Pin | STAT_LEDR_Pin | GPIO_PIN_3 | GPIO_PIN_4,
                    GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPS_RST_GPIO_Port, GPS_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : FC_INT_Pin STAT_LEDR_Pin PB3 PB4 */
  GPIO_InitStruct.Pin = FC_INT_Pin | STAT_LEDR_Pin | GPIO_PIN_3 | GPIO_PIN_4;
  ...
  /*Configure GPIO pin : GPS_PULSE_Pin */
